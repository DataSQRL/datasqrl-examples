# Data Catalog for the Healthcare Study Monitoring Example

This data catalog is used by the Healthcare Study Monitoring Example which demonstrates DataSQRL's capabilities in
