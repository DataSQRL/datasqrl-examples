...
#
# EXAMPLES (using this project's own sub-project, creditcard_analytics)
#   ./run-tests.sh                                              test every suite, env test
#   ./run-tests.sh creditcard_analytics                         test just that sub-project
#   ./run-tests.sh --compile --env dev                          compile every suite as dev
#   ./run-tests.sh --compile --env dev creditcard_analytics     compile just that one, as dev
#   ./run-tests.sh --list-invocations --compile --env dev       show what would run
#
...
ENVS="test dev"
SUBPROJECTS="creditcard_analytics"
# ─────────────────────────────────────────────────────────────────────────────
...
suite() {
  case "$1/$2" in
    creditcard_analytics/test) echo "creditcard_analytics-shared-package.json creditcard_analytics-test-package.json" ;;
    creditcard_analytics/dev)  echo "creditcard_analytics-shared-package.json creditcard_analytics-dev-package.json"  ;;
    *) return 1 ;;
  esac
}
