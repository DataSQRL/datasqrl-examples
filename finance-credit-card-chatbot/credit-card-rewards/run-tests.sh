...
#   ./run-tests.sh creditcard_rewards                         test just that sub-project
#   ./run-tests.sh --compile --env dev                          compile every suite as dev
#   ./run-tests.sh --compile --env dev creditcard_rewards     compile just that one, as dev
...
ENVS="test dev"
SUBPROJECTS="creditcard_rewards"
# ─────────────────────────────────────────────────────────────────────────────
...
suite() {
  case "$1/$2" in
    creditcard_rewards/test) echo "creditcard_rewards-shared-package.json creditcard_rewards-test-package.json" ;;
    creditcard_rewards/dev)  echo "creditcard_rewards-shared-package.json creditcard_rewards-dev-package.json"  ;;
    *) return 1 ;;
  esac
}
